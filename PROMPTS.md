...
> This file documents the system prompts, persona engineering directives, editorial judgment criteria, and conversation trajectories used to construct the **Autonomous AI Creator** project.

---

## 1. Core System & Persona Engineering Directives

### Persona 1: Ada — AI Security Researcher
```markdown
...
### Persona 2: Nova — ML Systems Architect
```markdown
...
### Persona 3: Cipher — AI Ethics & Governance Lead
```markdown
...
def evaluate_candidate(candidate, persona):
    ...
    4. Technical Depth & Source Credibility (0-30 pts): Verifies source (ArXiv, HuggingFace, GitHub).
...
- **Step 2**: Created `app/agent/persona.py` defining 4 rich tech personas (Ada, Nova, Cipher, Astra).
- **Step 3**: Created `app/agent/discovery.py` connecting live HackerNews API, ArXiv RSS, and HuggingFace feeds.
